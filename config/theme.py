...
def load_theme() -> None:
    """Injeta o CSS do tema corporativo."""
    st.markdown(
        f"""
<style>
/* ========== 0 RESET =========== */
...
/* remove o traço vertical que separa body × sidebar */
...
/* —— 3-B INPUTS (modo claro consistente) —— */
input, textarea,
...
div[data-testid="stAppViewContainer"] > .main .block-container {{
    /* força cinza-escuro em qualquer texto do conteúdo principal */
    color: {AMARO_TXT_CINZA} !important;
}}
div[data-testid="stAppViewContainer"] > .main .block-container * {{
    color: {AMARO_TXT_CINZA} !important;
